...
|-------|------------|--------------|
| 1 | [SMC + SMC + DF](https://github.com/HojunKim00920/6DOF-quadrotor-SMC-controller) | DF feedforward introduced into SMC baseline |
| 2 | **This repo** — INDI + SMC + DF | Position loop replaced with INDI outer loop |
